...
export default function PhotoSphere(props: Props) {
    ...
    return (
        <div className={`${props.visible ? "" : "hidden"} absolute group border-2 rounded-full border-white h-4 w-4 bg-photosphere-${props.color}`} style={{top: `calc(${props.topPos}% - 8px)`, left: `calc(${props.leftPos}% - 8px)`}}>
