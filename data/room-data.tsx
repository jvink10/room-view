...
export const exampleRoom = {
    ...
    photospheres: [
        {id: 1, name: "Bardon Esplanade Park", image: "/bardon-esplanade-park.jpg", topPos: 75, leftPos: 21, color: "bg-green-500"},
        {id: 2, name: "Bardon Park Bridge", image: "/bardon-park-bridge.jpg", topPos: 68, leftPos: 68, color: "bg-blue-400"},
        {id: 3, name: "Bowman Park", image: "/bowman-park.jpg", topPos: 94, leftPos: 53, color: "bg-green-500"},
        ...
        {id: 8, name: "St. Josephs Lunch Area", image: "/st-josephs-lunch-area.jpg", topPos: 87, leftPos: 67, color: "bg-yellow-400"},
    ],
};
