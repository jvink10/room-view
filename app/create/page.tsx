...
export default function Create() {
    return (
        <main>
            <Link href="/room" className="flex flex-row items-center my-16 mx-auto border-2 rounded-xl border-gray-100 p-8 h-48 w-2/3 max-w-2xl space-x-4 text-gray-400">
